...
const translations = {
  en: {
    ...
    reminderSyncBannerText: "Saved locally on this device.",
    reminderSyncBannerBtn: "Enable push notifications",
    ...
    quickCreateNotifyAtTime: "At what time?",
    quickCreateNotifyMorning: "Morning · 9 am",
    quickCreateNotifyNoon: "Noon · 12 pm",
    quickCreateNotifyEvening: "Evening · 6 pm",
    quickCreateNotifyHint: "We'll send a push notification on your device.",
    quickCreateReminderDateLabel: "When is the event?",
    quickCreateCelebrationDateLabel: "Celebration date",
    quickCreateEventToday: "Today",
    quickCreateTitleWillSaveAs: "Will be saved as:",
    ...
    quickCreateDateLabel: "Date",
    quickCreateReminderCategoryLabel: "Category",
    quickCreateCelebrationCategoryLabel: "Style",
    quickCreateOccasionLabel:            "What's the occasion?",
    quickCreateOccasionBirthday:         "Birthday",
    quickCreateOccasionAnniversary:      "Anniversary",
    quickCreateOccasionHoliday:          "Holiday",
    quickCreateOccasionOther:            "Other",
    quickCreateAnniversaryFor:           "{name}'s Anniversary",
    quickCreateReminderNameLabel: "Reminder name",
    quickCreateTitleRequired: "Give your reminder a name so you know what it's for",
    quickCreateTitlePreview: "Will be saved as: \u201c{title}\u201d",
    quickCreateCelebrationDesc: "Choose the date and style, then you'll configure your badge drop — what it looks like, who can claim it, and more.",
    ...
    dropsManageTabSeries:    "Convocatoria",
    ...
    // ── Series view UI ──────────────────────────────────────────────────────
    seriesLeading:                    "Leading",
    seriesVote:                       "Vote",
    seriesVoted:                      "Voted",
    seriesVoteSingular:               "vote",
    seriesVotePlural:                 "votes",
    seriesOpenStatus:                 "Open",
    seriesClosedStatus:               "Closed",
    seriesWinner:                     "Winner",
    seriesVotingCloses:               "Voting closes",
    seriesNoSubmissions:              "No submissions yet.",
    seriesFirstArtist:                "Be the first to submit!",
    seriesVoteInstructions:           "Tap any design to vote. You can change your vote any time.",
    seriesConnectToVote:              "Connect your UP to vote.",
    seriesGridOnly:                   "Open this app inside the LUKSO Grid to vote or submit artwork.",
    seriesSubmitDesignCta:            "Submit your design",
    seriesSubmitArtworkTitle:         "Submit your artwork",
    seriesSubmitArtworkHint:          "Upload your badge design. PNG, JPG, GIF or SVG — max 10 MB.",
    seriesArtistStatement:            "Artist statement (optional)",
    seriesArtistStatementPlaceholder: "Tell us about your design…",
    seriesSubmitCta:                  "Submit artwork",
    seriesUploadingCta:               "Uploading…",
    seriesPickImageFirst:             "Pick an image first",
    seriesFileTooLarge:               "File too large (max 10 MB)",
    seriesNoWallet:                   "No wallet connected",

    // ── Upcoming personal celebrations ─────────────────────────────────────
    dropsMyUpcoming:       "Your upcoming",
    dropsBirthdayLabel:    "Birthday",
    dropsUPAnnivLabel:     "UP Anniversary",
    dropsTomorrowLabel:    "Tomorrow",
    dropsInDays:           "in {n} days",
    dropsSocialBirthdays:  "Upcoming birthdays",
  ...
  es: {
    ...
    reminderSyncBannerText: "Guardado localmente en este dispositivo.",
    reminderSyncBannerBtn: "Activar notificaciones push",
    ...
    quickCreateNotifyAtTime: "¿A qué hora?",
    quickCreateNotifyMorning: "Mañana · 9 am",
    quickCreateNotifyNoon: "Mediodía · 12 pm",
    quickCreateNotifyEvening: "Tarde · 6 pm",
    quickCreateNotifyHint: "Te enviamos una notificación push en tu dispositivo.",
    quickCreateReminderDateLabel: "¿Cuándo es el evento?",
    quickCreateCelebrationDateLabel: "Fecha de la celebración",
    quickCreateEventToday: "Hoy",
    quickCreateTitleWillSaveAs: "Se guardará como:",
    ...
    quickCreateDateLabel: "Fecha",
    quickCreateReminderCategoryLabel: "Categoría",
    quickCreateCelebrationCategoryLabel: "Estilo",
    quickCreateOccasionLabel:            "¿Cuál es la ocasión?",
    quickCreateOccasionBirthday:         "Cumpleaños",
    quickCreateOccasionAnniversary:      "Aniversario",
    quickCreateOccasionHoliday:          "Festividad",
    quickCreateOccasionOther:            "Otro",
    quickCreateAnniversaryFor:           "Aniversario de {name}",
    quickCreateReminderNameLabel: "Nombre del recordatorio",
    quickCreateTitleRequired: "Pónle un nombre para saber de qué se trata",
    quickCreateTitlePreview: "Se guardará como: \u201c{title}\u201d",
    quickCreateCelebrationDesc: "Elige la fecha y el estilo; luego configurarás tu drop de badge: diseño, quién puede reclamarlo y más.",
    ...
    seriesVote:                       "Votar",
    seriesVoted:                      "Votado",
    seriesVoteSingular:               "voto",
    seriesVotePlural:                 "votos",
    seriesOpenStatus:                 "Abierta",
    seriesClosedStatus:               "Cerrada",
    seriesWinner:                     "Ganadora",
    seriesVotingCloses:               "Votación cierra",
    seriesNoSubmissions:              "Sin propuestas aún.",
    seriesFirstArtist:                "¡Sé el primero en participar!",
    seriesVoteInstructions:           "Toca cualquier diseño para votar. Puedes cambiar tu voto en cualquier momento.",
    seriesConnectToVote:              "Conecta tu UP para votar.",
    seriesGridOnly:                   "Abre esta app en el LUKSO Grid para votar o enviar arte.",
    seriesSubmitDesignCta:            "Propón tu diseño",
    seriesSubmitArtworkTitle:         "Envía tu obra",
    seriesSubmitArtworkHint:          "Sube tu diseño de insignia. PNG, JPG, GIF o SVG — máx. 10 MB.",
    seriesArtistStatement:            "Descripción del artista (opcional)",
    seriesArtistStatementPlaceholder: "Cuéntanos sobre tu diseño…",
    seriesSubmitCta:                  "Enviar obra",
    seriesUploadingCta:               "Subiendo…",
    seriesPickImageFirst:             "Elige una imagen primero",
    seriesFileTooLarge:               "Archivo muy grande (máx. 10 MB)",
    seriesNoWallet:                   "Sin cartera conectada",

    // ── Próximas celebraciones personales ──────────────────────────────────
    dropsMyUpcoming:       "Tus próximas",
    dropsBirthdayLabel:    "Cumpleaños",
    dropsUPAnnivLabel:     "Aniversario UP",
    dropsTomorrowLabel:    "Mañana",
    dropsInDays:           "en {n} días",
    dropsSocialBirthdays:  "Próximos cumpleaños",
