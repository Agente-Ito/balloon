...
const translations = {
  en: {
    ...
    toastDropCreated:     "Celebration created. Let the balloons rise!",
  ...
  es: {
    ...
    dropFormCoHostsMetaNote: "Por ahora, los co-celebradores se guardan en la metadata de descripción del drop.",
    ...
    toastDropCreated:     "Celebración creada, que comiencen los globos",
