...
const translations = {
  ...
  es: {
    ...
    dropMore:                "más",
    dropMineBadge:           "Tu drop",
    dropHostLoadingName:     "Resolviendo perfil…",
    dropReasonNotFound:      "Drop no encontrado",
    dropReasonWindowClosed:  "La ventana del drop no está abierta",
    dropReasonSoldOut:       "Drop agotado",
    dropReasonAlreadyClaimed:"Ya reclamaste este drop",
    ...
    dropReasonUnknown:       "No eres elegible para este drop",
    ...
    dropsMyCampaigns:        "Tus drops activos",
